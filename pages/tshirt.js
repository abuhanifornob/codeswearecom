          ...
          <div className="flex flex-wrap -m-4">
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-lg">
              ...
              >
                <img
                  alt="ecommerce"
                  className="mx-auto h-[36vh] md:h-[30vh] w-3/5 md:w-3/4 block"
              ...
              <div className="mt-4">
                <h3 className="text-gray-800 text-xs tracking-widest title-font mb-1">
                  Fruit of the Loom Men's Big & Tall Eversoft Cotton T-Shirts
                </h3>
                <h2 className="text-gray-900 title-font text-lg font-medium">
                  Weare the t-shirt{" "}
                </h2>
                <p className="mt-1">TK 450</p>
                <p className="mt-1 text-gray-800">XS,S,M,L,XL,XXL,XXXL</p>
              </div>
            </div>
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-lg">
              <Link
            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-lg">
              ...
              >
                <img
                  alt="ecommerce"
                  className="mx-auto h-[36vh] md:h-[30vh] w-2/4 md:w-3/4 block"
                  src="https://m.media-amazon.com/images/I/71fi5ur9P7L._AC_UL400_.jpg"
                />
              </Link>
              <div className="mt-4">
            ...
            {/* <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
                        ...
                        <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
                            <Link href={"/product/weare-t-shirt"} className="block relative h-48 rounded overflow-hidden">
